...
void start_monitor(struct file_data *record_data, time_t exec_time, Status status) {
...
//        printf("%d %d \n", (int) record_data->last_modification.tv_sec, (int) file_stat.st_mtim.tv_sec);
